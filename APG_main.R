...
# read in sp500 data
sp500.data <- read.csv("^GSPC (7).csv")
...
cov.factor = read_excel("Cov_period4.xlsx", col_names = FALSE)
...
#----Bar plots-----------------------------------------
#----------------------------------------------------------
barplot_weights(dcc.port.weights, "DCC long-only GMV")
barplot_weights(deco.port.weights, "DECO long-only GMV")
barplot_weights(bdeco.port.weights, "BLOCK-DECO long-only GMV")
barplot_weights(addaptive.port.weights, "Adaptive Tresholding long-only GMV")
barplot_weights(sample.port.weights, "Sample covariance long-only GMV")
barplot_weights(combined.port.weights, "Forecast Combinations long-only GMV")
barplot_weights(factor.port.weights, "Factor model long-only GMV")
